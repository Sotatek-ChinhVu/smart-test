...
public class SetOrdInfModel
{
    public SetOrdInfModel(int hpId, int setCd, long rpNo, long rpEdaNo, long ptId, int sinDate, int hokenPid, int odrKouiKbn, string rpName, int inoutKbn, int sikyuKbn, int syohoSbt, int santeiKbn, int tosekiKbn, int daysCnt, int sortNo, int isDeleted, long id, DateTime createDate, int createId, string createName, GroupKoui groupKoui, List<SetOrdInfDetailModel> ordInfDetails)
    {
        HpId = hpId;
        SetCd = setCd;
        RpNo = rpNo;
    ...
    public List<SetOrdInfDetailModel> OrdInfDetails { get; private set; }
}
