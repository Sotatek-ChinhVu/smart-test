namespace Domain.Models.OrdInfDetail
{
    public class OrdInfDetailDto
    {
        ...
        public OrdInfDetailDto(long raiinNo, long rpNo, long rpEdaNo, int rowNo, int sinDate, int sinKouiKbn, string itemCd, string itemName, double suryo, string unitName, int unitSbt, double termVal, int kohatuKbn, int syohoKbn, int syohoLimitKbn, int drugKbn, int yohoKbn, string kokuji1, string kokuji2, int isNodspRece, string ipnCd, string ipnName, string reqCd, int inOutKbn, double yakka, bool isGetPriceInYakka, int refillSetting, double ten, int alternationIndex, int kensaGaichu, double odrTermVal, double cnvTermVal, string yjCd)
        {
            RaiinNo = raiinNo;
            RpNo = rpNo;
            RpEdaNo = rpEdaNo;
