namespace Domain.Models.CalcStatus
{
    public class CalcStatusModel
    {
        public CalcStatusModel(long ptId, long ptNum, int sinDate, int seikyuUp, int calcMode, int clearReceChk, int status, string biko)
        {
            PtId = ptId;
            PtNum = ptNum;
            SinDate = sinDate;
