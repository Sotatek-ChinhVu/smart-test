namespace Domain.Models.RaiinKubunMst
{
    public class RaiinKubunDetailModel
    {
        ...
        public int IsAutoDeleted { get; private set; }
        ...
        public RaiinKubunDetailModel(int hpId, int groupId, int kubunCd, int sortNo, string kubunName, string colorCd, bool isConfirmed, int isAuto, int isAutoDeleted, bool isDeleted, List<RaiinKbnKouiModel> raiinKbnKouiModels, List<RaiinKbnItemModel> raiinKbnItemModels, List<RsvFrameMstModel> rsvFrameMstModels, List<RsvGrpMstModel> rsvGrpMstModels, List<RaiinKbnYayokuModel> raiinKbnYayokuModels)
        {
            HpId = hpId;
            GroupId = groupId;
            KubunCd = kubunCd;
