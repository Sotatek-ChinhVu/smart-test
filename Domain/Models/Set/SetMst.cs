namespace Domain.Models.Set
{
    public class SetMst
    {
        public SetMst(int hpId, int setCd, int setKbn, int setKbnEdaNo, int generationId, int level1, int level2, int level3, string setName, int weightKbn, int color, int isDeleted, int isGroup)
        {
            HpId = hpId;
            SetCd = setCd;
            SetKbn = setKbn;
