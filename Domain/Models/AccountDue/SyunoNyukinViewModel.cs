...
public class SyunoNyukinViewModel
{
    public SyunoNyukinViewModel(int hpId, long ptId, int sinDate, long raiinNo, long seqNo, int sortNo, int adjustFutan, int nyukinGaku, int paymentMethodCd, int nyukinDate, int uketukeSbt, string nyukinCmt, int nyukinjiTensu, int nyukinjiSeikyu, string nyukinjiDetail)
    {
        HpId = hpId;
        PtId = ptId;
        SinDate = sinDate;
