...
namespace Domain.Models.HistoryOrder
{
    ...
    {
        (int, List<HistoryOrderModel>) GetList(int hpId, int userId, long ptId, int sinDate, int offset, int limit, int filterId, int isDeleted, long raiinNo = 0, bool isGetAll = true);
