...
namespace Domain.Models.Accounting
{
    public interface IAccountingRepository : IRepositoryBase
    {
        ...
        bool SaveAccounting(List<SyunoSeikyuModel> syunoSeikyuModels, int hpId, long ptId, int userId, int sumAdjust, int thisWari, int thisCredit, int payType, string comment);
    }
}
