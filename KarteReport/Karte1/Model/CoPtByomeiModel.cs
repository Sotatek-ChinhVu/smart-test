...
namespace KarteReport.Karte1.Model
{
    public class CoPtByomeiModel
    {
        ...
        [JsonPropertyName("ByomeiStartDateWFormat")]
        public string ByomeiStartDateWFormat
        {
            get => CIUtil.SDateToShowWDate3(StartDate).Ymd;
        }

        [JsonPropertyName("ByomeiTenkiDateWFormat")]
        public string ByomeiTenkiDateWFormat
        {
            get => CIUtil.SDateToShowWDate3(TenkiDate).Ymd;
        }

        [JsonPropertyName("TenkiChusiMaru")]
        public bool TenkiChusiMaru
        {
            get => TenkiKbn == TenkiKbnConst.Canceled;
        }

        [JsonPropertyName("TenkiSiboMaru")]
        public bool TenkiSiboMaru
        {
            get => TenkiKbn == TenkiKbnConst.Dead;
        }

        [JsonPropertyName("TenkiSonota")]
        public bool TenkiSonota
        {
            get => TenkiKbn == TenkiKbnConst.Other;
        }

        [JsonPropertyName("TenkiTiyuMaru")]
        public bool TenkiTiyuMaru
        {
            get => TenkiKbn == TenkiKbnConst.Cured;
        }
    }
}
