...
namespace Helper.Constants
{
    ...
    {
        public static readonly ImmutableDictionary<int, List<string>> AgeSource =
        ...
        public static readonly ImmutableDictionary<int, List<string>> DiseaseSource =
            new Dictionary<int, List<string>>
            {
                {1, new List<string>() { "#ff99cc", "#ff5eaf", "禁忌" } },
        ...
        public static readonly ImmutableDictionary<int, List<string>> FoodAllegySource =
            new Dictionary<int, List<string>>
            {
                {1, new List<string>() { "#ff99cc", "#ff5eaf", "禁忌" } },
                {2, new List<string>() { "#ff9999", "#ff5454", "原則禁忌" } },
        ...
        public static readonly ImmutableDictionary<int, List<string>> DrugAllegySource =
            new Dictionary<int, List<string>>
            {
        ...
        public static readonly ImmutableDictionary<int, List<string>> KinkiCommonSource =
            new Dictionary<int, List<string>>
            {
        ...
        public static readonly ImmutableDictionary<int, List<string>> DuplicationCommonSource =
            new Dictionary<int, List<string>>
            {
