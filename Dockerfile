FROM 519870134487.dkr.ecr.ap-northeast-1.amazonaws.com/smartkarte-be-base:lates AS build-env
...
#Build runtime image
FROM FROM 519870134487.dkr.ecr.ap-northeast-1.amazonaws.com/smartkarte-be-base:lates
