        ...
        public UpdateDataTenantOutputData Handle(UpdateDataTenantInputData inputData)
        {
            try
            {
              ...
              .Sum();
                ...
                var result = UpdateDataTenant.ExcuteUpdateDataTenant(listFileScriptSql, subFoldersMasters, tenant.EndPointDb, ConfigConstant.PgPortDefault, tenant.Db,
                     ConfigConstant.PgUserDefault, ConfigConstant.PgPasswordDefault, inputData.CancellationToken, _messenger, totalFileExcute, pathFile7z, pathFolderUpdateDataTenant, tenant.TenantId);
