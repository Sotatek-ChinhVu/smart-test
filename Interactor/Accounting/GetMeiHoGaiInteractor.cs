...
namespace Interactor.Accounting
{
    public class GetMeiHoGaiInteractor : IGetMeiHoGaiInputPort
    {
        ...
        public GetMeiHoGaiOutputData Handle(GetMeiHoGaiInputData inputData)
        {
            try
            {
                var raiinNos = _accountingRepository.GetRaiinNos(inputData.HpId, inputData.PtId, inputData.RaiinNo, false);
        ...
        {
            SinMeiDataModelDto sinMeiViewModelDto = _calculateService.GetSinMeiList(sinMeiInputData);
