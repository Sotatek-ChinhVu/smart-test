        ...
        public F17CommonOutputData Handle(F17CommonInputData inputData)
        {
            try
            {
                if (inputData.UsingKensaItemCd != "" && inputData.UsingItemCds.Count != 0)
                {
                    ...
                    if (result)
                    {
                        return new F17CommonOutputData(new(), F17CommonStatus.Success, new(), new(), new(), new(), new(), new());
                    }
                    else
                    {
                        return new F17CommonOutputData(new(), F17CommonStatus.Failed, new(), new(), new(), new(), new(), new());
                    }
                }
                else if (inputData.KensaStdItemCd != "")
                {
                    ...
                    if (data.Count == 0)
                    {
                        return new F17CommonOutputData(new(), F17CommonStatus.NoData, new(), new(), new(), new(), new(), new());
                    }
                    else
                    {
                        return new F17CommonOutputData(new(), F17CommonStatus.Success, data, new(), new(), new(), new(), new());
                    }
                }
                else
                {
                    ...
                    {
                        return new F17CommonOutputData(kensaItemCds, F17CommonStatus.Success, new(), itemCds, materialMsts, containerMsts, kensaCenterMsts, tenOfItem);
                    }
                }
            }
            finally
