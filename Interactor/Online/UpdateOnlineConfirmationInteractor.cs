...
public class UpdateOnlineConfirmationInteractor : IUpdateOnlineConfirmationInputPort
{
    ...
    private void ConvertToListOnlConfirmHistoryModel(int userId, QCBIDXmlMsgResponse responseFile)
    {
        ...
        MessageHeader messageHeaderRes = responseFile.MessageHeader ?? new();
        ...
        foreach (var qCBIDMsgResponseInfo in messageBodyRes.QCBIDXmlMsgResponseInfo)
        {
            ...
            // 資格確認照会用情報
            msgResponseInfoBody.QualificationConfirmSearchInfo = qCBIDMsgResponseInfo == null || qCBIDMsgResponseInfo.QualificationConfirmSearchInfo == null ? new() : new ConfirmResultQualificationConfirmSearchInfo()
            {
            ...
            // 資格確認結果リスト
            var resultOfQualificationConfirmationRes = qCBIDMsgResponseInfo?.ResultOfQualificationConfirmation ?? new();
            ...
            msgResponseInfoBody.ResultList = new ConfirmResultResultList()
            {
                ResultOfQualificationConfirmation = new ConfirmResultResultOfQualificationConfirmation()
                {
                    ...
                    ElderlyRecipientCertificateInfo = resultOfQualificationConfirmationRes == null || resultOfQualificationConfirmationRes.ElderlyRecipientCertificateInfo == null ? new() : new ConfirmResultElderlyRecipientCertificateInfo()
                    {
                    ...
                    LimitApplicationCertificateChanged = resultOfQualificationConfirmationRes?.LimitApplicationCertificateChanged ?? string.Empty,
                    ReferenceNumber = qCBIDMsgResponseInfo?.ReferenceNumber ?? string.Empty,
                }
            };
