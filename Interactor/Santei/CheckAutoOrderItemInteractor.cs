...
{
    public class CheckAutoOrderItemInteractor : IGetOrdInfListTreeInputPort
    {
        private readonly ISanteiRepository _santeiRepository;
        public CheckAutoOrderItemInteractor(ISanteiRepository santeiRepository)
        {
            _santeiRepository = santeiRepository;
        }
