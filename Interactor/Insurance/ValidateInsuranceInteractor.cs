...
namespace Interactor.Insurance
{
    public class ValidateInsuranceInteractor : IValidateInsuranceInputPort
    {
        ...
        {
            // get hokenMst
            var hokenMst = _patientInforRepository.GetHokenMstByInfor(item.HpId, item.HokenInf.HokenNo, item.HokenInf.HokenEdaNo, sinDate);
            ...
            // Kohi1
            // get hokenMst Kohi1
            var hokenMstKohi1 = _patientInforRepository.GetHokenMstByInfor(item.HpId, item.Kohi1.HokenNo, item.Kohi1.HokenEdaNo, sinDate);
            ...
            // Kohi2
            // get hokenMst Kohi2
            var hokenMstKohi2 = _patientInforRepository.GetHokenMstByInfor(item.HpId, item.Kohi2.HokenNo, item.Kohi2.HokenEdaNo, sinDate);
            ...
            // Kohi3
            // get hokenMst Kohi3
            var hokenMstKohi3 = _patientInforRepository.GetHokenMstByInfor(item.HpId, item.Kohi3.HokenNo, item.Kohi3.HokenEdaNo, sinDate);
            ...
            // Kohi4
            // get hokenMst Kohi4
            var hokenMstKohi4 = _patientInforRepository.GetHokenMstByInfor(item.HpId, item.Kohi4.HokenNo, item.Kohi4.HokenEdaNo, sinDate);
