    ...
    public class GetInsuranceComboListInteractor : IGetInsuranceComboListInputPort
    {
        ...
        public GetInsuranceComboListOutputData Handle(GetInsuranceComboListInputData inputData)
        {
            try
            {
                ...
                return new GetInsuranceComboListOutputData(data.Select(x => new GetInsuranceComboItemOuputData(x.HokenPid, x.HokenName, x.IsExpirated, x.DisplayRateOnly, x.IsShaho, x.IsKokuho, x.HokenInf.HokenId, x.HokenInf.HokenKbn, x.HokenInf.HokenSentaku)).ToList(), GetInsuranceComboListStatus.Successed);
            }
            catch
            {
