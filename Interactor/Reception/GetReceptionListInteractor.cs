...
public class GetReceptionListInteractor : IGetReceptionListInputPort
{
    ...
    public GetReceptionListOutputData Handle(GetReceptionListInputData inputData)
    {
        try
        {
            ...
            var receptionInfos = _receptionRepository.GetList(inputData.HpId, inputData.SinDate, inputData.RaiinNo, inputData.PtId, false, inputData.IsGetFamily, inputData.IsDeleted, inputData.SearchSameVisit);
