...
namespace Infrastructure.Repositories
{
    public class MedicalExaminationRepository : RepositoryBase, IMedicalExaminationRepository
    {
        ...
        public void UpdateKensaMst(int hpId, int userId, List<KensaMstModel> kensaMstModels, List<TenMstModel> tenMstModels)
        {
        ...
        private TenMst ConvertTenMasterList(TenMstModel u, int userId, int hpId)
        {
            return new TenMst
            {
                HpId = hpId,
