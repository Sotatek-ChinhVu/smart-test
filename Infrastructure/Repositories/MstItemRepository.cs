...
namespace Infrastructure.Repositories
{
    public class MstItemRepository : RepositoryBase, IMstItemRepository
    {
            ...
            bool isSearch831SuffixOnly, bool isSearchGazoDensibaitaiHozon, FilterTenMstEnum sortMode)
        {
            ...
            {
                FilterTenMstEnum.RousaiKbnAsc => tenMstModels.OrderBy(item => item.RousaiKbn),
                FilterTenMstEnum.RousaiKbnDec => tenMstModels.OrderByDescending(item => item.RousaiKbn),
                ...
                FilterTenMstEnum.KohatuKbnAsc => tenMstModels.OrderBy(item => item.KohatuKbn),
                FilterTenMstEnum.KohatuKbnDec => tenMstModels.OrderByDescending(item => item.KohatuKbn),
                ...
                FilterTenMstEnum.TenAsc => tenMstModels.OrderBy(item => item.TenDisplay),
                FilterTenMstEnum.TenDec => tenMstModels.OrderByDescending(item => item.TenDisplay),
