...
namespace Infrastructure.Repositories
{
    public class OrdInfDetailRepository : IOrdInfDetailRepository
    {
        ...
        public void Create(OrdInfDetail ord)
        {
        ...
        public IEnumerable<OrdInfDetail> GetAll()
        {
            var result = _tenantDataContext.OdrInfDetails.AsQueryable().Select(o => new OrdInfDetail(
        ...
        public IEnumerable<OrdInfDetail> GetList(long ptId, long raiinNo, int sinDate)
        {
            var result = _tenantDataContext.OdrInfDetails.Where(o => o.PtId == ptId && o.RaiinNo == raiinNo && o.SinDate == sinDate).Select(o => new OrdInfDetail(
                o.HpId, o.RaiinNo, o.RpNo, o.RpEdaNo, o.RowNo, o.PtId, o.SinDate, o.SinKouiKbn, o.ItemCd, o.ItemName, o.Suryo, o.UnitName, o.UnitSBT, o.TermVal, o.KohatuKbn, o.SyohoKbn, o.SyohoLimitKbn, o.DrugKbn, o.YohoKbn, o.Kokuji1, o.Kokiji2, o.IsNodspRece, o.IpnCd, o.IpnName, o.JissiKbn, o.JissiDate, o.JissiId, o.JissiMachine, o.ReqCd, o.Bunkatu, o.CmtName, o.CmtOpt, o.FontColor, o.CommentNewline));
            return result;
        }
        ...
        public OrdInfDetail Read(int ordId, long raiinNo, long rpNo, long rpEdaNo, int rowNo)
        {
            throw new NotImplementedException();
        }

        public void Update(OrdInfDetail ordDetail)
        {
            throw new NotImplementedException();
        }
    }
