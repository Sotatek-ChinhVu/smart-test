...
namespace Infrastructure.Repositories
{
    public class KensaSetRepository : RepositoryBase, IKensaSetRepository
    {
        ...
        public ListKensaInfDetailModel GetDataChart(int hpId, int userId, long ptId, int setId, int iraiCdStart, bool getGetPrevious, bool showAbnormalKbn, int itemQuantity, List<long> listSeqNoItems)
        {
            IQueryable<KensaInfDetail> kensaInfDetails;
            ...
            if (1 == 1)
            {
                data.Where(x => listSeqNoItems.Contains(x.SeqNo));
            }
