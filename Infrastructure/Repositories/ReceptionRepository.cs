    ...
    public class ReceptionRepository : IReceptionRepository
    {
        ...
        private List<ReceptionRowModel> GetReceptionRowModels(int hpId, int sinDate, List<int> grpIds)
        {
            ...
            var models = raiins.Select(r => new ReceptionRowModel(
                ...
                r.ptInf.Sex,
                r.ptInf.Birthday,
                r.raiinInf.YoyakuTime,
                r.relatedRsvFrameMst?.RsvFrameName,
                r.uketukeSbtName,
                r.raiinInf.UketukeTime,
                r.raiinInf.SinStartTime,
                r.raiinInf.SinEndTime,
                r.raiinInf.KaikeiTime,
                r.relatedRaiinCmtInfComment?.Text,
                r.ptCmtInf?.Text,
                r.tantoName,
                r.kaName,
                r.lastVisitDate,
                r.primaryDoctorName,
                r.relatedRaiinCmtInfRemark?.Text,
