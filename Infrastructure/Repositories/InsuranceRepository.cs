            ...
            if (itemList.Count > 0)
            {
                foreach (var item in itemList)
                {
                    ...
                    InsuranceModel insuranceModel = new InsuranceModel(
                        ...
                        kohi1: GetKohiInfModel(item.ptKohi1, item.ptHokenCheckOfKohi1, item.hokenMst1, sinDate, GetConfirmDateList(2, item.ptKohi1.HokenId)),
                        kohi2: GetKohiInfModel(item.ptKohi2, item.ptHokenCheckOfKohi2, item.hokenMst2, sinDate, GetConfirmDateList(2, item.ptKohi2.HokenId)),
                        kohi3: GetKohiInfModel(item.ptKohi3, item.ptHokenCheckOfKohi3, item.hokenMst3, sinDate, GetConfirmDateList(2, item.ptKohi3.HokenId)),
                        kohi4: GetKohiInfModel(item.ptKohi4, item.ptHokenCheckOfKohi4, item.hokenMst4, sinDate, GetConfirmDateList(2, item.ptKohi4.HokenId)),
                        item.KogakuKbn,
                        item.TasukaiYm,
                        item.TokureiYm1,
                        item.TokureiYm2,
