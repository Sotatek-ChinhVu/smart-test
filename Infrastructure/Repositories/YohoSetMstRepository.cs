...
namespace Infrastructure.Repositories
{
    public class YohoSetMstRepository : RepositoryBase, IYohoSetMstRepository
    {
        ...
        public IEnumerable<YohoSetMstModel> GetByItemCd(int hpId, int userId, string itemcd, int startDate)
        {
            ...
            var yohoMsts = NoTrackingDataContext.YohoSetMsts.Where(x => x.IsDeleted == DeleteStatus.None && (x.ItemCd != null && x.ItemCd.Equals(itemcd)) && x.UserId == userId).ToList();
