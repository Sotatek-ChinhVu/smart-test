...
public class PhysicalInfoRepository : IPhysicalInfoRepository
{
    private readonly TenantNoTrackingDataContext _tenantDataContext;

    public PhysicalInfoRepository(ITenantProvider tenantProvider)
    {
        _tenantDataContext = tenantProvider.GetNoTrackingDataContext();
    }

    public List<PhysicalInfoModel> GetList(int hpId, long ptId)
    {
