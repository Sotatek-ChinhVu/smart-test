        ...
        public Dictionary<long, List<RaiinListInfModel>> GetRaiinListInf(int hpId, long ptId)
        {
            ...
            var raiinListInfs =
               (
                  ...
                  select new { raiinListInf.SinDate, raiinListInf.RaiinNo, raiinListMst.GrpId, raiinListMst.KbnCd, raiinListInf.RaiinListKbn, raiinListMst.KbnName, raiinListMst.ColorCd }
               ).ToList();
