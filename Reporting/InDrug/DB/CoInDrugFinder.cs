...
{
    public class CoInDrugFinder :  ICoInDrugFinder
    {
        ...
        public CoPtInfModel FindPtInf(int hpId, long ptId, int sinDate)
        {
            ...
            var ptInfs = dbService.PatientInfoRepository.FindListQueryableNoTrack(p =>
            p.HpId == hpId &&
                     p.PtId == ptId &&
                     p.IsDelete == DeleteStatus.None
                );

            var ptCmts = dbService.PtCmtInfRepository.FindListQueryableNoTrack(p =>
                    p.HpId == hpId &&
                    p.PtId == ptId &&
        ...
        {
            var ptAlrgyDrugs = dbService.PtAlrgyDrugRepository.FindListQueryableNoTrack(p =>
                    p.HpId == hpId &&
                    p.PtId == ptId &&
                    p.StartDate <= sinDate &&
        ...
        {
            var ptAlrgyFoods = dbService.PtAlrgyFoodRepository.FindListQueryableNoTrack(p =>
                   p.HpId == hpId &&
                   p.PtId == ptId &&
            p.StartDate <= sinDate &&
                   (p.EndDate >= sinDate || p.EndDate == 0) &&
            ...
            var foodAlrgyKbns = dbService.M12FoodAlrgyKbnRepository.FindListQueryableNoTrack();
        ...
        {
            var ptAlrgyElses = dbService.PtAlrgyElseRepository.FindListQueryableNoTrack(p =>
                    p.HpId == hpId &&
                    p.PtId == ptId &&
                    p.StartDate <= sinDate &&
                    (p.EndDate >= sinDate || p.EndDate == 0) &&
        ...
        {
            var kaMsts = dbService.KaMstRepositorycs.FindListQueryableNoTrack(o =>
                o.HpId == hpId &&
                o.IsDeleted == DeleteStatus.None);
            var userMsts = dbService.UserMstRepository.FindListQueryableNoTrack(o =>
                o.HpId == hpId &&
                o.IsDeleted == DeleteStatus.None);
            var uketukeSbtMsts = dbService.UketukeSbtMstRepository.FindListQueryableNoTrack(o =>
                o.HpId == hpId &&
                o.IsDeleted == DeleteStatus.None);
            var raiinCmtInfs = dbService.RaiinCmtInfRepository.FindListQueryableNoTrack(o =>
            o.HpId == hpId &&
            o.PtId == ptId &&
                o.CmtKbn == 1 &&
                o.RaiinNo == raiinNo
                );
            var raiinInfs = dbService.RaiinInfRepository.FindListQueryableNoTrack(p =>
                p.HpId == hpId &&
                p.PtId == ptId &&
                p.SinDate == sinDate &&
                p.RaiinNo == raiinNo &&
        ...
        public List<CoOdrInfModel> FindOdrInf(int hpId, long ptId, int sinDate, long raiinNo)
        {
            ...
            var odrInfs = dbService.OdrInfRepository.FindListQueryableNoTrack(o =>
                o.HpId == hpId &&
                o.PtId == ptId &&
                o.SinDate == sinDate &&
                o.RaiinNo == raiinNo &&
        ...
        public List<CoOdrInfDetailModel> FindOdrInfDetail(int hpId, long ptId, int sinDate, long raiinNo)
        {
            ...
            var odrInfDetails = dbService.OdrInfDetailRepository.FindListQueryableNoTrack(o =>
                o.HpId == hpId &&
            o.PtId == ptId &&
            o.SinDate == sinDate &&
                !(o.ItemCd != null && o.ItemCd.StartsWith("8") && o.ItemCd.Length == 9));
            var tenMsts = dbService.TenMstRepository.FindListQueryableNoTrack(t =>
                t.HpId == hpId &&
                t.StartDate <= sinDate &&
