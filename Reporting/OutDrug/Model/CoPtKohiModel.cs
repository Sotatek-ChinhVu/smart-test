...
public class CoPtKohiModel
{
    ...
    public KohiPriority KohiPriority { get; }

    public CoPtKohiModel(PtKohi ptKohi, HokenMst hokenMst, KohiPriority kohiPriority)
    {
        PtKohi = ptKohi;
        HokenMst = hokenMst;
        KohiPriority = kohiPriority;
    }

    public CoPtKohiModel()
    {
        PtKohi = new();
        HokenMst = new();
        KohiPriority = new();
    ...
    public int SortKey
    {
        get
        {
            return (KohiPriority == null ? 99999 : CIUtil.StrToIntDef(KohiPriority.PriorityNo, 99999)) * 1000 + CIUtil.StrToIntDef(HokenMst.Houbetu ?? string.Empty, 999);
        }
    }
