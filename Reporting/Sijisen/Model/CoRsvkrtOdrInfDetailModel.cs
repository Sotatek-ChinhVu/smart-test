...
namespace Reporting.Sijisen.Model
{
    public class CoRsvkrtOdrInfDetailModel
    {
        ...
        public CoRsvkrtOdrInfDetailModel(RsvkrtOdrInfDetail rsvkrtOdrInfDetail, RsvkrtOdrInf rsvkrtOdrInf, TenMst tenMst, KensaMst kensaMst, MaterialMst materialMst, ContainerMst containerMst)
        {
            ...
            TenMst = tenMst;
            MaterialMst = materialMst;
            ContainerMst = containerMst;
        }
        ...
        {
            get { return MaterialMst != null ? (MaterialMst.MaterialName ?? "") : ""; }
        }
        /// <summary>
        /// 容器名称
        /// </summary>
        ...
        {
            get { return ContainerMst != null ? (ContainerMst.ContainerName ?? "") : ""; }
        }
    }
}
