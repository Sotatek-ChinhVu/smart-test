    ...
    public class CoPtInfModel
    {
        ...
        public string AgeDsp
        {
            get
            {
                ...
                if (CIUtil.SDateToDecodeAge(Birthday, SinDate, ref age, ref month, ref day))
                {
                    if (age > 0)
                    {
                        ret = $"{age}歳";
        ...
        public string PtCmt
        {
            get { return PtCmtInf != null ? (PtCmtInf.Text ?? "") : ""; }
        }
        ...
        public List<string> AlrgyDrug
        {
            get
            {
                ...
                if (PtAlrgyDrugs != null && PtAlrgyDrugs.Any())
                {
        ...
        public List<string> AlrgyFood
        {
            get
            {
                ...
                if (PtAlrgyFoods != null && PtAlrgyFoods.Any())
                {
        ...
        public List<string> AlrgyElse
        {
            get
            {
                ...
                if (PtAlrgyElses != null && PtAlrgyElses.Any())
                {
