namespace Reporting.CommonMasters.Constants;
...
public static class PrefCode
{
    ...
    {
        return ((hokensyaNo ?? string.Empty).Length >= 6) && new string[] { "1", "51" }.Contains(
                    hokensyaNo?.Substring(hokensyaNo.Length - 6, 2)
                );
    }
    public static bool isAomori(string hokensyaNo)
    {
        return ((hokensyaNo ?? string.Empty).Length >= 6) && new string[] { "2", "52" }.Contains(
                    hokensyaNo?.Substring(hokensyaNo.Length - 6, 2)
                );
    }
    ...
    {
        return
             ((hokensyaNo ?? string.Empty).Length >= 6) &&
