...
public interface ISta3040CoReportService
{
    ...
    CommonExcelReportingModel ExportCsv(CoSta3040PrintConf printConf, int monthFrom, int monthTo, string menuName, int hpId, bool isPutColName, bool isPutTotalRow);
}
