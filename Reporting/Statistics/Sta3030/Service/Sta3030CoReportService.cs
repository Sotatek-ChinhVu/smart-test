...
public class Sta3030CoReportService : ISta3030CoReportService
{
    ...
    public CommonExcelReportingModel ExportCsv(CoSta3030PrintConf printConf, int monthFrom, int monthTo, string menuName, int hpId, bool isPutColName, bool isPutTotalRow)
    {
        this.printConf = printConf;
