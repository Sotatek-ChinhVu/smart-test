        ...
        if (!printConf.IsExcludeUnpaid)
        {
            ...
            var joinSeikyu = (
                ...
                select new
                {
                    ...
                    PtFutan = kaikeiFutanj.PtFutan == null ? 0 : kaikeiFutanj.PtFutan,
                    JihiFutan = kaikeiFutanj.JihiFutan == null ? 0 : kaikeiFutanj.JihiFutan,
                    JihiTax = kaikeiFutanj.JihiTax == null ? 0 : kaikeiFutanj.JihiTax,
                    KaikeiAdjustFutan = -(kaikeiFutanj.AdjustFutan == null ? 0 : kaikeiFutanj.AdjustFutan),
                    //HokenKbn = kaikeiHokenj.HokenKbn,
                    //HokenSbtCd = kaikeiHokenj.HokenSbtCd,
                    //ReceSbt = kaikeiHokenj.ReceSbt,
                    raiinInf.OyaRaiinNo,
                    raiinInf.KaId,
                    KaSname = kaMstj.KaSname == null ? string.Empty : kaMstj.KaSname,
                    raiinInf.TantoId,
                    TantoSname = tantoMst.Sname == null ? string.Empty : tantoMst.Sname,
                    raiinInf.UketukeTime,
                    raiinInf.KaikeiTime,
                    raiinInf.UketukeId,
                    UketukeSname = uketukeUserMst.Sname == null ? string.Empty : uketukeUserMst.Sname,
                    raiinInf.SyosaisinKbn,
                    raiinInf.UketukeSbt,
                    ptInf.PtNum,
                    PtName = ptInf.Name,
                    PtKanaName = ptInf.KanaName,
                    UketukeSbtName = uketukeSbtMstj.KbnName == null ? string.Empty : uketukeSbtMstj.KbnName,
                    firstRaiin.FirstRaiinDate
                }
            );
