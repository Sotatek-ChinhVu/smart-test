...
namespace Reporting.Statistics.Sta1001.DB
{
    public class CoSta1001Finder : RepositoryBase, ICoSta1001Finder
    {
        ...
        public List<CoSyunoInfModel> GetSyunoInfs(int hpId, CoSta1001PrintConf printConf, int staMonthType)
        {
            ...
            //会計情報
            //var kaikeiInfs = NoTrackingDataContext.KaikeiInfRepository.FindListQueryableNoTrack();
            ...
            //保険パターン
            //var ptHokenPatterns = NoTrackingDataContext.PtHokenPatternRepository.FindListQueryableNoTrack(p => p.IsDeleted == DeleteStatus.None);
            ...
            if (!printConf.IsExcludeUnpaid)
            {
                ...
                var joinSeikyu = (
                    ...
                    select new
                    {
                        ...
                        NyukinSeqNo = syunoNyukinj.SeqNo,
                        NyukinAdjustFutan = syunoNyukinj.AdjustFutan,
                        NyukinPaymentMethodCd = syunoNyukinj.PaymentMethodCd,
                        NyukinSortNo = syunoNyukinj.SortNo,
                        NyukinGaku = syunoNyukinj.NyukinGaku,
                        NyukinDate = syunoNyukinj.NyukinDate,
                        NyukinUpdateId = syunoNyukinj.UpdateId,
                        NyukinCmt = syunoNyukinj.NyukinCmt,
                        NyukinUpdateDate = syunoNyukinj.UpdateDate,
        ...
        public List<CoJihiSbtFutan> GetJihiSbtFutan(int hpId, CoSta1001PrintConf printConf)
        {
            ...
            var sinRpInfs = NoTrackingDataContext.SinRpInfs.Where(x => x.HpId == hpId);
        ...
        {
            return
                NoTrackingDataContext.RaiinCmtInfs.Where(r =>
                    r.HpId == hpId &&
                    r.RaiinNo == raiinNo &&
                    r.CmtKbn == 1 &&
