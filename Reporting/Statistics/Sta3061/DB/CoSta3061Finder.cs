...
public class CoSta3061Finder : RepositoryBase, ICoSta3061Finder
{
    ...
    public CoSta3061Finder(ITenantProvider tenantProvider, ICoHpInfFinder hpInfFinder) : base(tenantProvider)
    {
    ...
    public List<CoKouiTensuModel> GetKouiTensu(int hpId, CoSta3061PrintConf printConf)
    {
        ...
        var joinQuery = (
            ...
            select new
            {
                ...
                Sex = sinGroupj.Max(x => x.ptInf.Sex),
                ...
                KohiCount = sinGroupj.Max(x => x.ptKohiJoin.kohiCount),
        ...
        if (printConf.PtGrpId > 0)
        {
            ...
            foreach (var retData in retDatas)
            {
                ...
                retData.PtGrpCode = curGrps?.GrpCode;
