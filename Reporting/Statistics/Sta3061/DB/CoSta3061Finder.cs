        ...
        try
        {
            ...
            var joinQuery = (
                ...
                select new CoKouiTensuModel()
                {
                    ...
                    PtName = sinGroupj != null && sinGroupj.Any() ? sinGroupj.Max(x => x.ptInf?.Name ?? string.Empty) ?? string.Empty : string.Empty,
                    ...
                    KaSname = sinGroupj != null && sinGroupj.Any() ? sinGroupj.Max(x => x.kaMstj?.KaSname ?? string.Empty) ?? string.Empty : string.Empty,
                    TantoId = sinGroupj.Key.TantoId,
                    TantoSname = sinGroupj != null && sinGroupj.Any() ? sinGroupj.Max(x => x.tantoMst?.Sname ?? string.Empty) ?? string.Empty : string.Empty,
                    ...
                    TotalTensu = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.CdKbn != "SZ" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn != null && x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    //診察計  ----------
                    Tensu1x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("1")) || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "A", "B", "C" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count1x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki == "1100" || x.sinKoui.SyukeiSaki == "1200") && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                        sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("13")) || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("14")) || (x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "A", "B", "C" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "1450" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                        sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "1450" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //初診
                    Tensu11 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("11")) || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A11") && x.sinKoui.CdKbn == "A")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count11 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki == "1100" || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A11") && x.sinKoui.CdKbn == "A")) && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //再診
                    Tensu12 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("12") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A12") && x.sinKoui.CdKbn == "A")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count12 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki == "1200" || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A12") && x.sinKoui.CdKbn == "A")) && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //医学管理
                    Tensu13 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("13") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A13") && x.sinKoui.CdKbn == "B")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count13 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("13") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A13") && x.sinKoui.CdKbn == "B")) && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //在宅
                    Tensu14x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("14") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && x.sinKoui.CdKbn == "C")) && x.sinKoui.SyukeiSaki != "1450" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count14x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("14") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && x.sinKoui.CdKbn == "C")) && x.sinKoui.SyukeiSaki != "1450" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //在宅薬剤
                    ...
                    //投薬計  ----------
                    Tensu2x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("2") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "F" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count2x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("2") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "F" }.Contains(x.sinKoui.CdKbn))) && !new string[] { "2100", "2200", "2300" }.Contains(x.sinKoui.SyukeiSaki) && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                    ...
                    //注射計  ----------
                    Tensu3x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3")) || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count3x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3")) || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.RecId != "IY" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                        sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3")) || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.RecId == "IY" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //皮下筋肉内注射
                    Tensu31 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("31") && x.sinKoui.RecId != "IY" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count31 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("31") && x.sinKoui.RecId != "IY" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //静脈内注射
                    Tensu32 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("32") && x.sinKoui.RecId != "IY" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count32 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("32") && x.sinKoui.RecId != "IY" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //その他注射
                    Tensu33 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("33") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.RecId != "IY" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count33 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("33") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.RecId != "IY" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //薬剤器材
                    Tensu39 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.RecId == "IY" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count39 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.RecId == "IY" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //処置計  ----------
                    Tensu4x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("4") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "J" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count4x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("4") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "J" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "4010" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                        sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "4010" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //処置手技
                    Tensu4000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("4") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "J" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "4010" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count4000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("4") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "J" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "4010" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //処置薬剤
                    ...
                    //手術計  ----------
                    Tensu5x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("5") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "K", "L" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count5x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("5") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "K", "L" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "5010" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                        sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "5010" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //手術手技
                    Tensu5000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("5") || (x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "K", "L" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "5010" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count5000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("5") || (x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "K", "L" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "5010" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //手術薬剤
                    ...
                    //検査計  ----------
                    Tensu6x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("6") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "D", "N" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count6x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("6") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "D", "N" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "6010" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                        sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "6010" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //検査手技
                    Tensu6000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("6") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "D", "N" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "6010" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count6000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("6") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "D", "N" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "6010" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //検査薬剤
                    ...
                    //画像計  ----------
                    Tensu7x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("7") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "E" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count7x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("7") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "E" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "7010" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                        sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "7010" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //画像手技
                    Tensu7000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("7") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "E" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "7010" && x.sinFilmj == null ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count7000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("7") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "E" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "7010" && x.sinFilmj == null && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //画像薬剤
                    ...
                    //画像フィルム
                    Tensu7f = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("7") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "E" }.Contains(x.sinKoui.CdKbn))) && x.sinFilmj != null ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count7f = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("7") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "E" }.Contains(x.sinKoui.CdKbn))) && x.sinFilmj != null ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //その他計  --------
                    Tensu8x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("8") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || x.sinKoui.SyukeiSaki.StartsWith("Z")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count8x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("8") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || x.sinKoui.SyukeiSaki.StartsWith("Z")) && x.sinKoui.SyukeiSaki != "8020" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                    ...
                    //その他(その他)
                    Tensu8010 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki == "8010" || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || x.sinKoui.SyukeiSaki.StartsWith("Z")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count8010 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki == "8010" || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || x.sinKoui.SyukeiSaki.StartsWith("Z")) && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //その他(薬剤)
            ...
            foreach (var retData in retDatas)
            {
                ...
                foreach (var jihiSbt in jihiSbtMsts.Select(item => item.JihiSbt).ToList())
                {
                    retData.JihiMeisais.Add
                    (
                        jihiMeisai.Find(j => j.RaiinNo == retData.RaiinNo && j.JihiSbt == jihiSbt)?.JihiFutan ?? 0
                    );
                    retData.CountJihiMeisais.Add
                    (
                        jihiMeisai.Find(j => j.RaiinNo == retData.RaiinNo && j.JihiSbt == jihiSbt)?.JihiCount ?? 0
                    );
                }
            }
        ...
        var retDatas =
            (from sinKoui in sinKouiList
             ...
             select new CoKouiTensuModel()
             {
                 ...
                 //診察計  ----------
                 Tensu1x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("1") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "A", "B", "C" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count1x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki == "1100" || x.sinKoui.SyukeiSaki == "1200") && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                             sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("13") || x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("14") || (x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "A", "B", "C" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "1450" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                             sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "1450" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //初診
                 Tensu11 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("11") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A11") && x.sinKoui.CdKbn == "A")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count11 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki == "1100" || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A11") && x.sinKoui.CdKbn == "A")) && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //再診
                 Tensu12 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("12") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A12") && x.sinKoui.CdKbn == "A")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count12 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki == "1200" || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A12") && x.sinKoui.CdKbn == "A")) && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //医学管理
                 Tensu13 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("13") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A13") && x.sinKoui.CdKbn == "B")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count13 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("13") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A13") && x.sinKoui.CdKbn == "B")) && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //在宅
                 ...
                 Tensu3x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count3x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.RecId != "IY" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                             sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3") || (x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.RecId == "IY" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //皮下筋肉内注射
                 Tensu31 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("31") && x.sinKoui.RecId != "IY" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count31 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("31") && x.sinKoui.RecId != "IY" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //静脈内注射
                 ...
                 Count5x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("5") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "K", "L" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "5010" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                             sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "5010" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //手術手技
                 Tensu5000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("5") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "K", "L" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "5010" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count5000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("5") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "K", "L" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "5010" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //手術薬剤
                 Tensu5010 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "5010" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count5010 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "5010" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //検査計  ----------
                 ...
                 Count7f = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("7") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "E" }.Contains(x.sinKoui.CdKbn))) && x.sinFilmj != null ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //その他計  --------
                 Tensu8x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("8") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("Z")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count8x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("8") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("Z")) && x.sinKoui.SyukeiSaki != "8020" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                             sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "8020" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //その他(処方せん)
                 Tensu8000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "8000" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count8000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "8000" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //その他(その他)
                 Tensu8010 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki == "8010" || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("Z")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count8010 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki == "8010" || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("Z")) && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //その他(薬剤)
                 Tensu8020 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "8020" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count8020 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki == "8020" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //自費計  ----------
