        ...
        try
        {
            ...
            var joinQuery = (
                ...
                select new CoKouiTensuModel()
                {
                    ...
                    TotalTensu = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.CdKbn != "SZ" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn != 0 && x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    //診察計  ----------
                    ...
                    Count1x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki == "1100" || x.sinKoui.SyukeiSaki == "1200") && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                        sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("13")) || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("14")) || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "A", "B", "C" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "1450" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                    ...
                    //手術手技
                    Tensu5000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("5") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "K", "L" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "5010" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count5000 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("5") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "K", "L" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.SyukeiSaki != "5010" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //手術薬剤
                    ...
                    //その他(その他)
                    Tensu8010 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki == "8010" || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("Z")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                    Count8010 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki == "8010" || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("Z")) && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                    //その他(薬剤)
        ...
        var retDatas =
            (from sinKoui in sinKouiList
             ...
             select new CoKouiTensuModel()
             {
                 ...
                 Tensu3x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count3x = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3") || (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.RecId != "IY" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0) +
                             sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && (x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("3") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) && x.sinKoui.RecId == "IY" ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //皮下筋肉内注射
                 Tensu31 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("31") && x.sinKoui.RecId != "IY" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),
                 Count31 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.SyukeiSaki != null && x.sinKoui.SyukeiSaki.StartsWith("31") && x.sinKoui.RecId != "IY" && x.sinCount.SeqNo == 1 && x.sinKoui.TenColCount > 0 ? (x.sinKoui.Ten == 0 ? 0 : x.sinCount.Count) : 0),
                 //静脈内注射
