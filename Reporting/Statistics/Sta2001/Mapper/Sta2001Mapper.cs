...
namespace Reporting.Statistics.Sta2001.Mapper;

public class Sta2001Mapper : CommonReportingRequest
{
    ...
    public Sta2001Mapper(Dictionary<string, string> singleFieldData, List<Dictionary<string, CellModel>> tableFieldData, Dictionary<string, string> extralData, string rowCountFieldName, string formFileName)
    {
