        ...
        s.SinYm <= printConf.EndSinYm
            ...
            var joinQuery = (
                ...
                select new
                {
                    ...
                    TensuA = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("1") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "A" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //初再診
                    TensuB = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("1") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "B" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //医学管理
                    TensuC = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("1") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "C" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //在宅
                    TensuD = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("6") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "D" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //検査
                    TensuE = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("7") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "E" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //画像診断
                    TensuF = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("2") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "F" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //投薬
                    TensuG = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("3") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "G" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //注射
                    TensuH = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("8") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "H" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //リハビリ
                    TensuI = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("8") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "I" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //精神
                    TensuJ = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("4") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "J" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //処置
                    TensuK = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("5") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "K" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //手術
                    TensuL = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("5") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "L" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //麻酔
                    TensuM = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("8") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "M" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //放射線治療
                    TensuN = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("6") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A")) && x.sinKoui.CdKbn == "N" ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //病理
                    Jihi =
                        sinGroupj.Sum
                        (x =>
                    ...
                    Tensu1 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("1") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "A", "B", "C" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //診察
                    Tensu2 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("2") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "F" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //投薬
                    Tensu3 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("3") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "G" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //注射
                    Tensu4 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("4") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "J" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //処置
                    Tensu5 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("5") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "K", "L" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //手術
                    Tensu6 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("6") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "D", "N" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //検査
                    Tensu7 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("7") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "E" }.Contains(x.sinKoui.CdKbn))) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //画像
                    Tensu8 = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("8") || ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A") && new string[] { "H", "I", "M", "R", "JB" }.Contains(x.sinKoui.CdKbn)) || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("Z")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0),  //その他
                    ...
                    TensuSyosin = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.CdKbn == "A" && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("11") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A11")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0), //初診
                    TensuSaisin = sinGroupj.Sum(x => x.sinRp.SanteiKbn != 2 && x.sinKoui.CdKbn == "A" && ((x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("12") || (x.sinKoui.SyukeiSaki ?? string.Empty).StartsWith("A12")) ? x.sinKoui.Ten / (x.sinKoui.EntenKbn == 1 ? 10 : 1) * x.sinCount.Count : 0)  //再診
                }
            );
