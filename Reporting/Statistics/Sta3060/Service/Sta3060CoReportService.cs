        ...
        void MakePrintData()
        {
            ...
            CoSta3060PrintData setPrintData(List<CoKouiTensuModel> coKouiTensus, int rowNo = 0)
            {
                ...
                printData.ReportKbn =
                    ...
                    printConf.ReportKbn == 6 ? coKouiTensus.First().PtNum.ToString().PadLeft(kouiTensus.Select(x => x.PtNum).DefaultIfEmpty()?.ToString().Length ?? 0) + " " + coKouiTensus.First().PtName :
                    string.Empty;
