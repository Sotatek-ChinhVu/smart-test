...
public interface ISta3071CoReportService
{
    ...
    CommonExcelReportingModel ExportCsv(CoSta3071PrintConf printConf, int hpId, bool isPutTotalRow, bool isPutColName, int monthFrom, int monthTo, string menuName);
}