...
public class StatisticService : IStatisticService
{
    ...
    public static CoSta3061PrintConf CreateCoSta3061PrintConf(ConfigStatistic3061Model configStatistic, int startDateFrom, int StartDateTo)
    {
