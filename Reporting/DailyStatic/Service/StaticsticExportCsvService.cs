...
{
    public class StaticsticExportCsvService : IStaticsticExportCsvService
    {
        ...
        public StaticsticExportCsvService(IDailyStatisticCommandFinder finder, ISta1001CoReportService sta1001CoReportService, ISta1002CoReportService sta1002CoReportService, ISta1010CoReportService sta1010CoReportService, ISta2001CoReportService sta2001CoReportService, ISta2002CoReportService sta2002CoReportService, ISta2003CoReportService sta2003CoReportService, ISta2010CoReportService sta2010CoReportService,
                                          ...
                                          ISta3030CoReportService sta3030CoReportService, ISta3040CoReportService sta3040CoReportService, ISta3041CoReportService sta3041CoReportService, ISta3050CoReportService sta3050CoReportService, ISta3060CoReportService sta3060CoReportService, ISta3070CoReportService sta3070CoReportService, ISta3061CoReportService sta3061CoReportService)
        {
            _finder = finder;
        ...
        public CommonExcelReportingModel ExportCsv(int hpId, string menuName, int menuId, int timeFrom, int timeTo, int? monthFrom = 0, int? monthTo = 0, int? dateFrom = 0, int? dateTo = 0, bool? isPutTotalRow = false, int? tenkiDateFrom = -1, int? tenkiDateTo = -1, int? enableRangeFrom = -1, int? enableRangeTo = -1, long? ptNumFrom = 0, long? ptNumTo = 0, bool? isPutColName = false, CoFileType? coFileType = null)
        {
            ...
            switch ((StatisticReportType)configDaily.ReportId)
            {
                ...
                case StatisticReportType.Sta2003:
                    result = PrintSta2003(hpId, configDaily, monthFrom ?? 0, monthTo ?? 0, menuName, isPutColName, isPutTotalRow, coFileType);
                    break;
                case StatisticReportType.Sta2010:
                    result = PrintSta2010(hpId, configDaily, monthFrom ?? 0, monthTo ?? 0, menuName, isPutColName, isPutTotalRow, coFileType);
                    break;
                case StatisticReportType.Sta2011:
                    result = PrintSta2011(hpId, configDaily, monthFrom ?? 0, monthTo ?? 0, menuName, isPutColName, isPutTotalRow, coFileType);
                    break;
                ...
                case StatisticReportType.Sta3010:
                    result = PrintSta3010(hpId, configDaily, dateFrom ?? 0, monthFrom ?? 0, monthTo ?? 0, menuName, isPutColName, isPutTotalRow, coFileType);
                    break;
                ...
                case StatisticReportType.Sta3041:
                    result = PrintSta3041(hpId, configDaily, monthFrom ?? 0, monthTo ?? 0, menuName, isPutColName, isPutTotalRow, coFileType);
                    break;
                case StatisticReportType.Sta3050:
                    result = PrintSta3050(hpId, configDaily, dateFrom ?? 0, dateTo ?? 0, ptNumFrom ?? 0, ptNumTo ?? 0, monthFrom ?? 0, monthTo ?? 0, menuName, isPutColName, isPutTotalRow, coFileType);
                    break;
        ...
        #region Print Report
        private CommonExcelReportingModel PrintSta1001(int hpId, ConfigStatisticModel configDaily, int dateFrom, int dateTo, int timeFrom, int timeTo, string menuName, bool? isPutColName, bool? isPutTotalRow)
        {
            CoSta1001PrintConf printConf = CreateCoSta1001PrintConf(configDaily, dateFrom, dateTo, timeFrom, timeTo);
            return _sta1001CoReportService.ExportCsv(printConf, dateFrom, dateTo, menuName, hpId, isPutColName ?? false, isPutTotalRow ?? false);
        }

        private CommonExcelReportingModel PrintSta1002(int hpId, ConfigStatisticModel configDaily, int dateFrom, int dateTo, int timeFrom, int timeTo, string menuName, bool? isPutColName, bool? isPutTotalRow)
        {
        ...
        private CommonExcelReportingModel PrintSta2001(int hpId, ConfigStatisticModel configDaily, int monthFrom, int monthTo, string menuName, bool? isPutColName, bool? isPutTotalRow)
        {
            ...
            return _sta2001CoReportService.ExportCsv(printConf, monthFrom, monthTo, menuName, hpId, isPutColName ?? false, isPutTotalRow ?? false);
        }

        private CommonExcelReportingModel PrintSta2002(int hpId, ConfigStatisticModel configDaily, int monthFrom, int monthTo, string menuName, bool? isPutColName, bool? isPutTotalRow)
        {
            var printConf = CreateCoSta2002PrintConf(configDaily, monthFrom, monthTo);
            return _sta2002CoReportService.ExportCsv(printConf, monthFrom, monthTo, menuName, hpId, isPutColName ?? false, isPutTotalRow ?? false);
        }

        private CommonExcelReportingModel PrintSta2003(int hpId, ConfigStatisticModel configDaily, int monthFrom, int monthTo, string menuName, bool? isPutColName, bool? isPutTotalRow, CoFileType? coFileType)
        {
            var printConf = CreateCoSta2003PrintConf(configDaily, monthFrom, monthTo);
            return _sta2003CoReportService.ExportCsv(printConf, monthFrom, monthTo, menuName, hpId, isPutColName ?? false, isPutTotalRow ?? false, coFileType ?? null);
        }

        private CommonExcelReportingModel PrintSta2010(int hpId, ConfigStatisticModel configDaily, int monthFrom, int monthTo, string menuName, bool? isPutColName, bool? isPutTotalRow, CoFileType? coFileType)
        {
            var printConf = CreateCoSta2010PrintConf(configDaily, monthFrom);
            return _sta2010CoReportService.ExportCsv(printConf, monthFrom, monthTo, menuName, hpId, isPutColName ?? false, isPutTotalRow ?? false, coFileType ?? null);
        }

        private CommonExcelReportingModel PrintSta2011(int hpId, ConfigStatisticModel configDaily, int monthFrom, int monthTo, string menuName, bool? isPutColName, bool? isPutTotalRow, CoFileType? coFileType)
        {
            var printConf = CreateCoSta2011PrintConf(configDaily, monthFrom);
            return _sta2011CoReportService.ExportCsv(printConf, monthFrom, monthTo, menuName, hpId, isPutColName ?? false, isPutTotalRow ?? false, coFileType ?? null);
        }

        private CommonExcelReportingModel PrintSta2021(int hpId, ConfigStatisticModel configDaily, int monthFrom, int monthTo, string menuName, bool? isPutColName, bool? isPutTotalRow, CoFileType? coFileType)
        {
        ...
        private CommonExcelReportingModel PrintSta3010(int hpId, ConfigStatisticModel configDaily, int dateFrom, int monthFrom, int monthTo, string menuName, bool? isPutColName, bool? isPutTotalRow, CoFileType? coFileType)
        {
            return _sta3010CoReportService.ExportCsv(CreateCoSta3010PrintConf(configDaily.ConfigStatistic3010, dateFrom), monthFrom, monthTo, menuName, hpId, isPutColName ?? false, isPutTotalRow ?? false, coFileType ?? null);
        }
        ...
        private CommonExcelReportingModel PrintSta3041(int hpId, ConfigStatisticModel configDaily, int monthFrom, int monthTo, string menuName, bool? isPutColName, bool? isPutTotalRow, CoFileType? coFileType)
        {
            return _sta3041CoReportService.ExportCsv(CreateCoSta3041PrintConf(configDaily.ConfigStatistic3041, monthFrom, monthTo), monthFrom, monthTo, menuName, hpId, isPutColName ?? false, isPutTotalRow ?? false, coFileType ?? null);
        }

        private CommonExcelReportingModel PrintSta3050(int hpId, ConfigStatisticModel configDaily, int startDateFrom, int startDateTo, long ptNumFrom, long ptNumTo, int monthFrom, int monthTo, string menuName, bool? isPutColName, bool? isPutTotalRow, CoFileType? coFileType)
        {
            return _sta3050CoReportService.ExportCsv(CreateCoSta3050PrintConf(configDaily.ConfigStatistic3050, monthFrom, monthTo, ptNumFrom, ptNumTo), monthFrom, monthTo, menuName, hpId, isPutColName ?? false, isPutTotalRow ?? false, coFileType ?? null);
        }

        private CommonExcelReportingModel PrintSta3060(int hpId, ConfigStatisticModel configDaily, int monthFrom, int monthTo, string menuName, bool? isPutColName, bool? isPutTotalRow, CoFileType? coFileType)
        {
