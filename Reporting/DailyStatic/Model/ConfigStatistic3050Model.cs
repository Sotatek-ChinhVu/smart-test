...
public class ConfigStatistic3050Model : StatisticModelBase
{
    public ConfigStatistic3050Model()
    {
    }

    public ConfigStatistic3050Model(StaMenu staMenu, List<StaConf> listStaConf)
    {
        StaMenu = staMenu;
    ...
    public ConfigStatistic3050Model(int groupId = 0, int reportId = 0, int sortNo = 0)
    {
        StaMenu = new StaMenu();
    ...
    public string KouseisinKbn
    {
        get
        {
            return GetValueConf(38);
        }
        set
        {
            SettingConfig(38, value);
        }
    }
    ...
    public string KohatuKbn
    {
        get
        {
            return GetValueConf(39);
        }
        set
        {
            SettingConfig(39, value);
        }
    }
    ...
    public void CopyConfig(ConfigStatistic3050Model configSource)
    {
