...
using static Reporting.Statistics.Sta3061.Models.CoSta3061PrintConf;

namespace Reporting.DailyStatic.Model;

public class ConfigStatistic3061Model : StatisticModelBase
{
    public ConfigStatistic3061Model()
    {
    }

    public ConfigStatistic3061Model(StaMenu staMenu, List<StaConf> listStaConf)
    {
        StaMenu = staMenu;
    ...
    public ConfigStatistic3061Model(int groupId = 0, int reportId = 0, int sortNo = 0)
    {
        StaMenu = new StaMenu();
    ...
    public void CopyConfig(ConfigStatistic3061Model configSource)
    {
