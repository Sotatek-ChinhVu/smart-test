...
public class ConfigStatistic3070Model : StatisticModelBase
{

    public ConfigStatistic3070Model(StaMenu staMenu, List<StaConf> listStaConf)
    {
        StaMenu = staMenu;
    ...
    public void CopyConfig(ConfigStatistic3070Model configSource)
    {
