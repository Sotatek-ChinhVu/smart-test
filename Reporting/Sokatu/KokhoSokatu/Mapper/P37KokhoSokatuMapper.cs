...
{
    public class P37KokhoSokatuMapper : CommonReportingRequest
    {
        ...
        public P37KokhoSokatuMapper(Dictionary<int, Dictionary<string, string>> singleFieldDataM, Dictionary<int, List<ListTextObject>> listTextData, Dictionary<string, string> extralData, string formFileName1, string formFileName2, Dictionary<string, string> singleFieldData, Dictionary<string, bool> visibleFieldData)
        {
        ...
        {
            { "1", _formFileName1 }, { "2", _formFileName2 }
        };
            return fileName;
        }
