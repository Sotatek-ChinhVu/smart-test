...
public class P44KokhoSokatuCoReportService : IP44KokhoSokatuCoReportService
{
    #region Constant
    ...
    /// OutPut Data
    /// </summary>
    private const string _formFileName = "p44KokhoSokatu.rse";
    ...
    public P44KokhoSokatuCoReportService(ICoKokhoSokatuFinder kokhoFinder)
    {
    ...
    public CommonReportingRequestModel GetP44KokhoSokatuReportingData(int hpId, int seikyuYm, SeikyuType seikyuType)
    {
        this.hpId = hpId;
