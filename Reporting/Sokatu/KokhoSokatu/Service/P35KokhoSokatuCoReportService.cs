...
{
    public class P35KokhoSokatuCoReportService : IP35KokhoSokatuCoReportService
    {
        #region Constant
        ...
        public P35KokhoSokatuCoReportService(ICoKokhoSokatuFinder kokhoFinder)
        {
        ...
        public CommonReportingRequestModel GetP35KokhoSokatuReportingData(int hpId, int seikyuYm, SeikyuType seikyuType)
        {
            try
            {
                this.hpId = hpId;
