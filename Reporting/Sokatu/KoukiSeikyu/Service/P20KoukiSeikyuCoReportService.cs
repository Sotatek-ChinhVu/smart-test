...
public class P20KoukiSeikyuCoReportService : IP20KoukiSeikyuCoReportService
{
    #region Constant
    ...
    private const string _formFileName = "p20KoukiSeikyu.rse";
    private readonly Dictionary<int, ReportConfigModel> _reportConfigPerPage;
    private readonly Dictionary<string, bool> _visibleAtPrint;

    #region Constructor and Init
    public P20KoukiSeikyuCoReportService(ICoKoukiSeikyuFinder kokhoFinder)
    {
    ...
    public CommonReportingRequestModel GetP20KoukiSeikyuReportingData(int hpId, int seikyuYm, SeikyuType seikyuType)
    {
        _hpId = hpId;
        _seikyuYm = seikyuYm;
    ...
    private bool UpdateDrawForm()
    {
        ...
        int UpdateFormHeader()
        {
            ...
            SetVisibleFieldData("kbnRate7", _seikyuYm < KaiseiDate.m202210);
            SetVisibleFieldData("kbnIppan", _seikyuYm >= KaiseiDate.m202210);
            SetVisibleFieldData("kbnRate7_2210", _seikyuYm >= KaiseiDate.m202210);
