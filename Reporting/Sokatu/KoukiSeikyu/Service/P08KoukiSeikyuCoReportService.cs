...
public class P08KoukiSeikyuCoReportService : IP08KoukiSeikyuCoReportService
{
    #region Constant
    private const int MyPrefNo = 08;
    #endregion
    ...
    private bool UpdateDrawForm()
    {
        ...
        int UpdateFormHeader()
        {
            ...
            SetVisibleFieldData("kbnRate9H", seikyuYm < KaiseiDate.m202210);
            SetVisibleFieldData("kbnIppan", this.seikyuYm >= KaiseiDate.m202210);
            SetVisibleFieldData("kbnIppanH", this.seikyuYm >= KaiseiDate.m202210);
