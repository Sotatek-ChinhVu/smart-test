...
public class P24KoukiSeikyuCoReportService : IP24KoukiSeikyuCoReportService
{
    #region Constant
    ...
    private const string _formFileName = "p24KoukiSeikyu.rse";

    #region Constructor and Init
    public P24KoukiSeikyuCoReportService(ICoKoukiSeikyuFinder kokhoFinder)
    {
    ...
    public CommonReportingRequestModel GetP24KoukiSeikyuReportingData(int hpId, int seikyuYm, SeikyuType seikyuType)
    {
        try
        {
            this.hpId = hpId;
