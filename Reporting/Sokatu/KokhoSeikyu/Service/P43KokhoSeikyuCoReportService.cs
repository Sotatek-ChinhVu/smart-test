...
{
    public class P43KokhoSeikyuCoReportService : IP43KokhoSeikyuCoReportService
    {
        #region Constant
        ...
        /// OutPut Data
        /// </summary>
        private string _formFileName = "p43KokhoSeikyu.rse";
        ...
        public P43KokhoSeikyuCoReportService(ICoKokhoSeikyuFinder kokhoFinder)
        {
        ...
        public CommonReportingRequestModel GetP43KokhoSeikyuReportingData(int hpId, int seikyuYm, SeikyuType seikyuType)
        {
            try
            {
                this.hpId = hpId;
