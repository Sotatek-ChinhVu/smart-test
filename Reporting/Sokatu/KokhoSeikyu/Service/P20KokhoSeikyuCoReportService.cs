...
public class P20KokhoSeikyuCoReportService : IP20KokhoSeikyuCoReportService
{
    #region Constant
    ...
    /// OutPut Data
    /// </summary>
    private const string _formFileName = "p20KokhoSeikyu.rse";
    ...
    public P20KokhoSeikyuCoReportService(ICoKokhoSeikyuFinder kokhoFinder)
    {
    ...
    public CommonReportingRequestModel Get20KokhoSeikyuReportingData(int hpId, int seikyuYm, SeikyuType seikyuType)
    {
        this.hpId = hpId;
