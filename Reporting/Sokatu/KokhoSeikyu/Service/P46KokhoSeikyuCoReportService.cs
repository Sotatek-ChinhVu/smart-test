...
{
    public class P46KokhoSeikyuCoReportService : IP46KokhoSeikyuCoReportService
    {
        ...
        private const string _formFileNameP1 = "p46KokhoSeikyuP1.rse";
        private const string _formFileNameP2 = "p46KokhoSeikyuP2.rse";
        ...
        public P46KokhoSeikyuCoReportService(ICoKokhoSeikyuFinder kokhoFinder)
        {
        ...
        public CommonReportingRequestModel GetP46KokhoSeikyuReportingData(int hpId, int seikyuYm, SeikyuType seikyuType, List<string> printHokensyaNos)
        {
            try
            {
                this.hpId = hpId;
