...
{
    public class P44KokhoSeikyuCoReportService : IP44KokhoSeikyuCoReportService
    {
        #region Constant
        ...
        private const string _formFileNameP1 = "p44KokhoSeikyuP1.rse";
        private const string _formFileNameP2 = "p44KokhoSeikyuP2.rse";
        ...
        public P44KokhoSeikyuCoReportService(ICoKokhoSeikyuFinder kokhoFinder)
        {
        ...
        private bool UpdateDrawForm()
        {
            ...
            int UpdateFormBodyP1()
            {
                ...
                int kohiHeiyo = curReceInfs.Where(r => r.IsHeiyo).ToList().Count;
        ...
        public CommonReportingRequestModel GetP44KokhoSeikyuReportingData(int hpId, int seikyuYm, SeikyuType seikyuType, List<string> printHokensyaNos)
        {
            try
            {
                this.hpId = hpId;
