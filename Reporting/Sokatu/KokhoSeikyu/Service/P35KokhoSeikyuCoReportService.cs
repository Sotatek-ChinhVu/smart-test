...
{
    public class P35KokhoSeikyuCoReportService : IP35KokhoSeikyuCoReportService
    {
        #region Constant
        ...
        private const string _formFileNameP1 = "p35KokhoSeikyuP1.rse";
        private const string _formFileNameP2 = "p35KokhoSeikyuP2.rse";
        ...
        public P35KokhoSeikyuCoReportService(ICoKokhoSeikyuFinder kokhoFinder) : base()
        {
        ...
        private bool GetData()
        {
            ...
            //保険者番号リストを取得（県外（国保→国保組合）→県内（国保組合→国保））
        ...
        public CommonReportingRequestModel GetP35KokhoSeikyuReportingData(int hpId, int seikyuYm, SeikyuType seikyuType, List<string> printHokensyaNos)
        {
            try
            {
                this.hpId = hpId;
