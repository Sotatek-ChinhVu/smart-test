namespace CommonCheckers.OrderRealtimeChecker.Services
{
        ...
        where TOdrDetail : class, IOdrInfDetailModel
    {
        ...
        public void InjectFinder(IRealtimeCheckerFinder finder, IMasterFinder masterFinder)
        {
            _finder = finder;
        ...
        private List<PtAlrgyDrug> _listPtAlrgyDrug;
        private List<PtAlrgyFood> _listPtAlrgyFood;
        private List<PtOtherDrug> _listPtOtherDrug;
        private List<PtOtcDrug> _listPtOtcDrug;
        private List<PtSupple> _listPtSupple;
        private List<PtKioReki> _listPtKioReki;
        ...
        public List<string> ListPtAlrgyDrugCode
        {
            get
            {
                if (_listPtAlrgyDrugCode == null)
                {
                    ...
                    {
                        List<PtAlrgyDrug> drugAllergyAsPatient = _finder.GetDrugAllergyByPtId(_hpID, _ptID, _sinday);
