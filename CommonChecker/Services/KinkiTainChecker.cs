...
{
    public class KinkiTainChecker<TOdrInf, TOdrDetail> : UnitChecker<TOdrInf, TOdrDetail>
        ...
        where TOdrDetail : class, IOdrInfoDetailModel
    {
        ...
        public override UnitCheckerForOrderListResult<TOdrInf, TOdrDetail> HandleCheckOrderList(UnitCheckerForOrderListResult<TOdrInf, TOdrDetail> unitCheckerForOrderListResult)
        {
            ...
            List<KinkiResultModel> checkedResult = Finder!.CheckKinkiTain(HpID, PtID, Sinday, settingLevel, listItemCode, unitCheckerForOrderListResult.SpecialNoteModel.ImportantNoteModel.OtherDrugItems, unitCheckerForOrderListResult.IsDataOfDb);
