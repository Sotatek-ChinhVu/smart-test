...
namespace Entity.Tenant
{
    ...
    public class DosageDosage : EmrCloneable<DosageDosage>
    {
        ...
        [Column("KONOKOKA_CD")]
        [MaxLength(7)]
        public string KonokokaCd { get; set; }
        ...
        [Column("KENSA_PCD")]
        [MaxLength(7)]
        public string KensaPcd { get; set; }
        ...
        [MaxLength(400)]
        public string DrugCondition { get; set; }

        /// <summary>
        /// 効能効果
        /// </summary>
        [Column("KONOKOKA")]
        public string Konokoka { get; set; }
        ...
        [Column("FILENAME_CD")]
        [MaxLength(7)]
        public string FilenameCd { get; set; }

        /// <summary>
        /// 投与手技
        /// </summary>
        [Column("DRUG_SYUGI")]
        public string DrugSyugi { get; set; }
        ...
        [Column("TEKIO_BUI")]
        [MaxLength(300)]
        public string TekioBui { get; set; }
        ...
        [MaxLength(1500)]
        public string YoukaiKisyaku { get; set; }
        ...
        [Column("KISYAKUEKI")]
        [MaxLength(500)]
        public string Kisyakueki { get; set; }
        ...
        [Column("YOUKAIEKI")]
        [MaxLength(500)]
        public string Youkaieki { get; set; }
        ...
        [Column("HAITA_FLG")]
        [MaxLength(1)]
        public string HaitaFlg { get; set; }
        ...
        [MaxLength(500)]
        public string NgKisyakueki { get; set; }
        ...
        [Column("NG_YOUKAIEKI")]
        [MaxLength(500)]
        public string NgYoukaieki { get; set; }
        ...
        [Column("COMBI_DRUG")]
        [MaxLength(200)]
        public string CombiDrug { get; set; }
        ...
        [MaxLength(1)]
        public string SingleDrugFlg { get; set; }
        ...
        [Column("KYUGEN_CD")]
        [MaxLength(1)]
        public string KyugenCd { get; set; }
        ...
        [MaxLength(1)]
        public string DosageCheckFlg { get; set; }
        ...
        [MaxLength(30)]
        public string OnceLimitUnit { get; set; }
        ...
        [MaxLength(30)]
        public string DayLimitUnit { get; set; }
        ...
        [MaxLength(1)]
        public string DosageLimitUnit { get; set; }
        ...
        [MaxLength(30)]
        public string UnittermUnit { get; set; }
        ...
        [MaxLength(1)]
        public string DosageAddFlg { get; set; }
        ...
        [Column("INC_DEC_FLG")]
        [MaxLength(1)]
        public string IncDecFlg { get; set; }
        ...
        [MaxLength(1)]
        public string IncDecIntervalUnit { get; set; }
        ...
        [MaxLength(30)]
        public string IncDecLimitUnit { get; set; }
        ...
        [Column("TIME_DEPEND")]
        [MaxLength(1000)]
        public string TimeDepend { get; set; }
        ...
        [MaxLength(1)]
        public string JudgeTermUnit { get; set; }
        ...
        [Column("EXTEND_FLG")]
        [MaxLength(1)]
        public string ExtendFlg { get; set; }
        ...
        [MaxLength(1)]
        public string AddTermUnit { get; set; }
        ...
        [MaxLength(1)]
        public string IntervalWarningFlg { get; set; }
    }
}
