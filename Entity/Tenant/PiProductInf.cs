...
namespace Entity.Tenant
{
    ...
    public class PiProductInf : EmrCloneable<PiProductInf>
    {
        ...
        /// </summary>
        [Column("PI_ID_FULL")]
        public string PiIdFull { get; set; }
        ...
        [Column("SOSYO_NAME")]
        [MaxLength(80)]
        public string SosyoName { get; set; }
        ...
        [MaxLength(120)]
        public string GenericEngName { get; set; }
        ...
        /// </summary>
        [Column("YAKKA_REG")]
        public string YakkaReg { get; set; }
        ...
        /// </summary>
        [Column("YAKKA_DEL")]
        public string YakkaDel { get; set; }
        ...
        [Column("BIKO_PI_UNIT")]
        [MaxLength(512)]
        public string BikoPiUnit { get; set; }
        ...
        [MaxLength(256)]
        public string BikoPiBranch { get; set; }
