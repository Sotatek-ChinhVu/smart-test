...
namespace CloudUnitTest.Interactor.PatientInfo
{
    public class SavePatientInfoInteractorTest : BaseUT
    {
        ...
        [Test]
        public void TC_52_HasElderHoken_SinDay_Is_Less_Than_20080401()
        {
            //Mock
            var mockPatientInfo = new Mock<IPatientInforRepository>();
            var mockSystemConf = new Mock<ISystemConfRepository>();
        ...
        [Test]
        public void TC_53_HasElderHoken_WarningInsuranceElderlyLaterNotYetCovered()
        {
            //Mock
            var mockPatientInfo = new Mock<IPatientInforRepository>();
            var mockSystemConf = new Mock<ISystemConfRepository>();
        ...
        [Test]
        public void TC_54_HasElderHoken_WarningLaterInsuranceRegisteredPatientsElderInsurance()
        {
            //Mock
            var mockPatientInfo = new Mock<IPatientInforRepository>();
            var mockSystemConf = new Mock<ISystemConfRepository>();
            ...
            Assert.That(result.First().Code, Is.EqualTo(SavePatientInforValidationCode.WarningLaterInsuranceRegisteredPatientsElderInsurance));
        }

        [Test]
        public void TC_55_HasElderHoken_WarningInsuranceElderlyLaterNotYetCovered()
        {
            //Mock
            var mockPatientInfo = new Mock<IPatientInforRepository>();
            var mockSystemConf = new Mock<ISystemConfRepository>();
