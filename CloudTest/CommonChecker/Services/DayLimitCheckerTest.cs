...
public class DayLimitCheckerTest : BaseUT
{
    ...
    public void CheckDayLitmit_005_CommonMedicalCheck_CheckListOrder_GetErrorDetails_DaylimitError()
    {
        ...
        try
        {
            ...
            var errorDetails = commonMedicalCheck.GetErrorDetails(hpId, ptId, sinDay, listErrorInfo, new());

            // Assert
            Assert.True(!errorDetails.errors.Any());
        }
        finally
        {
            //Clear Data test
    ...
    /// <summary>
    /// GetUsingDay IsDrugUsage = true and result != -1
    /// </summary>
    [Test]
    public void Test_011_GetUsingDay_Test_Using_Info_IsNotNull()
    {
        ...
        // Act
        var result = dayLimitChecker.GetUsingDay(odrInfoModel[0]);
        // Assert
        Assert.IsTrue(result == 3);
    }

    /// <summary>
    /// GetUsingDay IsDrugUsage is false and result == -1
    /// </summary>
    [Test]
