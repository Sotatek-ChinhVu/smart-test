...
CREATE TABLE public."RAIIN_LIST_INF" (
	"HP_ID" int4 NOT NULL,
	"PT_ID" int8 NOT NULL,
	...
	"RAIIN_LIST_KBN" int4 NOT NULL DEFAULT 0,
	"ID" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY,
	CONSTRAINT raiin_list_inf_v3_pk PRIMARY KEY ("ID", "PT_ID"),
	CONSTRAINT raiin_list_inf_v3_un UNIQUE ("HP_ID", "PT_ID", "SIN_DATE", "RAIIN_NO", "GRP_ID", "RAIIN_LIST_KBN")
)
...
CREATE INDEX "RAIIN_LIST_INF_V3_IDX01" ON ONLY public."RAIIN_LIST_INF" USING btree ("GRP_ID", "KBN_CD", "RAIIN_LIST_KBN");
CREATE INDEX "RAIIN_LIST_INF_V3_IDX02" ON ONLY public."RAIIN_LIST_INF" USING btree ("HP_ID", "PT_ID", "RAIIN_NO");
CREATE INDEX raiin_list_inf_hp_id_v3_idx ON ONLY public."RAIIN_LIST_INF" USING btree ("HP_ID", "PT_ID");
