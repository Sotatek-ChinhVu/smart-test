...
namespace UseCase.Logger
{
    ...
    {
        public WriteLogInputData(string eventCd, long ptId, int sinDay, long raiinNo, string path, string requestInfo, string description, string logType, string loginId)
        {
            EventCd = eventCd;
            PtId = ptId;
            SinDay = sinDay;
