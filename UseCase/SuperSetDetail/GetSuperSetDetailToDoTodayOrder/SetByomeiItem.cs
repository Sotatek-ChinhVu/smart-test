...
namespace UseCase.SuperSetDetail.GetSuperSetDetailToDoTodayOrder
{
    ...
    {
        public SetByomeiItem(bool isSyobyoKbn, int sikkanKbn, int nanByoCd, string fullByomei, bool isSuspected, bool isDspRece, bool isDspKarte, string byomeiCmt, string byomeiCd, List<PrefixSuffixModel> prefixSuffixList)
        {
