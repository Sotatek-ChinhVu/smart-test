...
namespace UseCase.MedicalExamination.GetHistory
{
    public class GetMedicalExaminationHistoryInputData : IInputData<GetMedicalExaminationHistoryOutputData>
    {
        ...
        public GetMedicalExaminationHistoryInputData(long ptId, int hpId, int sinDate, int startPage, int pageSize, int userId, int searchType, int searchCategory, string searchText)
        {
            PtId = ptId;
            HpId = hpId;
            SinDate = sinDate;
