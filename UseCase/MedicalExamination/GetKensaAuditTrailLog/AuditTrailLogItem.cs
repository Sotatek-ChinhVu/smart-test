...
namespace UseCase.MedicalExamination.GetKensaAuditTrailLog
{
    ...
    {
        public AuditTrailLogItem(long logId, DateTime logDate, int hpId, int userId, string eventCd, long ptId, int sinDate, long raiinNo, string machine, string hosuke)
        {
            LogId = logId;
            LogDate = logDate;
            HpId = hpId;
