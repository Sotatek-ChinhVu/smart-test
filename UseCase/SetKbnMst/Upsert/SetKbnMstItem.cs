...
{
    public class SetKbnMstItem
    {
        public SetKbnMstItem(int hpId, int setKbn, int setKbnEdaNo, string setKbnName, int kaCd, int docCd, int isDeleted, int generationId)
        {
            HpId = hpId;
            SetKbn = setKbn;
