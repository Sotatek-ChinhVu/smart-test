...
{
    public class ValidOneKohiInputData : IInputData<ValidOneKohiOutputData>
    {
        public ValidOneKohiInputData(int sinDate, int ptBirthday, bool isKohiEmptyModel, bool isSelectedKohiMst, string selectedKohiFutansyaNo, string selectedKohiJyukyusyaNo, string selectedKohiTokusyuNo, int selectedKohiStartDate, int selectedKohiEndDate, int selectedKohiConfirmDate, int selectedKohiHokenNo, int selectedKohiHokenEdraNo, bool selectedKohiIsAddNew)
        {
            SinDate = sinDate;
