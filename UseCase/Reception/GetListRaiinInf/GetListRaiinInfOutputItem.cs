...
namespace UseCase.Reception.GetListRaiinInf
{
    ...
    {
        public GetListRaiinInfOutputItem(int hpId, long ptId, int sinDate, int uketukeNo, int status, string kaSname, string sName, string houbetu, string hokensyaNo, int hokenKbn, int hokenId, int hokenPid, long raiinNo)
        {
            HpId = hpId;
            PtId = ptId;
            SinDate = sinDate;
