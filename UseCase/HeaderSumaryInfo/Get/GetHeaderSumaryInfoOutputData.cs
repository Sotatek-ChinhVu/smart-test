...
namespace UseCase.HeaderSumaryInfo.Get
{
    ...
    {
        public GetHeaderSumaryInfoOutputData(List<PtInfNotificationItem> header1Info, List<PtInfNotificationItem> header2Info, List<PtInfNotificationItem> notification)
        {
