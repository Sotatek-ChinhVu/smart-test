namespace UseCase.PatientInfor.Save
{
    public enum SavePatientInforValidationCode
    {
        ...
        InvalidFirstNameKanaLength,
        InvalidFirstNameKanjiLength,
        InvalidLastKanaNameLength,
        InvalidLastKanjiNameLength,
        InvalidFirstNameKanji,
        InvalidLastKanaName,
        InvalidLastKanjiName,
        InvalidJiscodeCheck,
        InvalidChineseCharacterName,
        #region insurance
