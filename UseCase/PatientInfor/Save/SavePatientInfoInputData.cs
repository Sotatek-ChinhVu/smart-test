...
namespace UseCase.PatientInfor.Save
{
    ...
    {
        public SavePatientInfoInputData(PatientInforModel patient, PtInfSanteiConfModel ptSanteis, List<PtInfHokenPartternModel> hokenPartterns, List<PtGrpInfModel> ptGrps)
        {
            Patient = patient;
            PtSanteis = ptSanteis;
