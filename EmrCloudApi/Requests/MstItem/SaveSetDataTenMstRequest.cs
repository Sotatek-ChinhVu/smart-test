namespace EmrCloudApi.Requests.MstItem
{
    public class SaveSetDataTenMstRequest
    {
        ...
        #region HaihanTab
        public List<DensiHaihanModelDto> DensiHaihanModel1s { get; private set; } = new List<DensiHaihanModelDto>();

        public List<DensiHaihanModelDto> DensiHaihanModel2s { get; private set; } = new List<DensiHaihanModelDto>();

        public List<DensiHaihanModelDto> DensiHaihanModel3s { get; private set; } = new List<DensiHaihanModelDto>();
        #endregion

        #region HoukatsuTab
        public List<DensiHoukatuModelDto> ListDensiHoukatuModels { get; private set; } = new List<DensiHoukatuModelDto>();

        public List<DensiHoukatuGrpModelDto> ListDensiHoukatuGrpModels { get; private set; } = new List<DensiHoukatuGrpModelDto>();

        public List<DensiHoukatuModelDto> ListDensiHoukatuMaster { get; private set; } = new List<DensiHoukatuModelDto>();
        #endregion

        #region CombinedContraindicationTab
        public List<CombinedContraindicationModelDto> CombinedContraindications { get; private set; } = new List<CombinedContraindicationModelDto>();
        #endregion
    }
}
