...
namespace EmrCloudApi.Tenant.Presenters.OrdInfs
{
    public class GetHeaderInfPresenter : IGetHeaderInfOutputPort
    {
        ...
        public void Complete(GetHeaderInfOutputData outputData)
        {
            ...
            {
                Data = new GetHeaderInfResponse(outputData.SyosaiKbn, outputData.JikanKbn, outputData.HokenPid, outputData.SanteiKbn, outputData.TantoId, outputData.KaId, outputData.UketukeTime, outputData.SinStartTime, outputData.SinEndTime, outputData.TagNo, outputData.OdrInfs),
