...
namespace EmrCloudApi.Tenant.Controllers
{
    ...
    public class HistoryController : ControllerBase
    {
        ...
        {
            var input = new GetMedicalExaminationHistoryInputData(request.PtId, request.HpId, request.SinDate, request.PageIndex, request.PageSize, request.DeleteCondition, request.KarteDeleteHistory, request.FilterId, request.UserId, request.IsShowApproval);
