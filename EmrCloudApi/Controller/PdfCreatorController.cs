    ...
    public async Task<IActionResult> GetDataPrintDrugInfo([FromQuery] GetDataPrintDrugInfoRequest request)
    {
        ...
        switch (inputData.Type)
        {
            ...
            case TypeHTMLObject.ShowKanjaMuke:
                htmlData = _commonDrugInf.ShowKanjaMuke(inputData.HpId, inputData.ItemCd, inputData.Level, inputData.DrugName, inputData.YJCode);
                break;
            case TypeHTMLObject.ShowMdbByomei:
                htmlData = _commonDrugInf.ShowMdbByomei(inputData.HpId, inputData.ItemCd, inputData.Level, inputData.DrugName, inputData.YJCode);
                break;
        }
