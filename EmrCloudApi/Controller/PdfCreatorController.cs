...
public class PdfCreatorController : ControllerBase
{
    ...
    {
        var data = _reportService.GetReceiptData(request.HpId, request.PtId, request.SinYm, request.HokenId, request.SinDate, request.RaiinNo, request.isOpenedFromAccounting);
