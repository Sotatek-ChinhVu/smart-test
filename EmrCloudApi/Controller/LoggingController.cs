...
namespace EmrCloudApi.Controller
{
    ...
    public class LoggingController : AuthorizeControllerBase
    {
        ...
        {
            var input = new WriteLogInputData(request.EventCd, request.PtId, request.SinDay, request.RaiinNo, request.Path, request.RequestInfo, request.Description, request.LogType, request.LoginKey);
