...
namespace EmrCloudApi.Controller
{
    ...
    public class FlowSheetController : AuthorizeControllerBase
    {
        ...
        public ActionResult<Response<GetListFlowSheetResponse>> GetListFlowSheet([FromQuery] GetListFlowSheetRequest inputData)
        {
            ...
            watch.Start();
            var input = new GetListFlowSheetInputData(HpId, inputData.PtId, inputData.SinDate, inputData.RaiinNo, inputData.IsHolidayOnly, 0, 0, false, inputData.PageIndex, inputData.PageSize, inputData.SortData);
        ...
        {
            var input = new GetListFlowSheetInputData(HpId, 0, 0, 0, true, inputData.HolidayFrom, inputData.HolidayTo, false, 0, 0, new());
            var output = _bus.Handle(input);
        ...
        public ActionResult<Response<GetListRaiinMstResponse>> GetListRaiinMst([FromQuery] GetListRaiinMstRequest inputData)
        {
            ...
            var input = new GetListFlowSheetInputData(HpId, 0, 0, 0, false, 0, 0, true, 0, 0, new());
            var output = _bus.Handle(input);
