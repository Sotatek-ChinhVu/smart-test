...
public class GetYousiki1InfModelWithCommonInfPresenter : IGetYousiki1InfModelWithCommonInfOutputPort
{
    ...
    {
        Result.Data = new GetYousiki1InfModelWithCommonInfResponse(output.Yousiki1InfList.Select(item => new Yousiki1InfDto(item, output.KacodeYousikiMstDict)).ToList());
