...
public class SaveMedicalPresenter : ISaveMedicalOutputPort
{
    public Response<SaveMedicalResponse> Result { get; private set; } = default!;

    public void Complete(SaveMedicalOutputData outputData)
    {
