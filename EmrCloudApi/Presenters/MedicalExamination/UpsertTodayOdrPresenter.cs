...
namespace EmrCloudApi.Presenters.MedicalExamination
{
    public class UpsertTodayOdrPresenter : IUpsertTodayOrdOutputPort
    {
        ...
        public void Complete(UpsertTodayOrdOutputData outputData)
        {
            ...
            Result.Data = new UpsertTodayOdrResponse(outputData.Status, new RaiinInfItemResponse(outputData.ValidationRaiinInf, ConvertRaiinInfStatusToMessage(outputData.ValidationRaiinInf)), validations, validationKarte);
        }
