...
namespace EmrCloudApi.Presenters.MstItem
{
    public class F17CommonPresenter : IF17CommonOutputPort
    {
        ...
        public void Complete(F17CommonOutputData outputData)
        {
            ...
            {
                Data = new F17CommonResponse(outputData.KensaItemCd, outputData.Status, outputData.KensaStdMsts, outputData.ItemCd, outputData.MaterialMsts, outputData.ContainerMsts, outputData.KensaCenterMsts, outputData.TenOfItem),
