...
namespace EmrCloudApi.Configs.Dependency
{
    public class ModuleDependencySetup : IDependencySetup
    {
        ...
        private void SetupRepositories(IServiceCollection services)
        {
            ...
            services.AddScoped<IApprovalInfRepository, ApprovalinfRepository>();
            services.AddScoped<IPtDiseaseRepository, DiseaseRepository>();
            services.AddScoped<IOrdInfRepository, OrdInfRepository>();
            services.AddScoped<IReceptionRepository, ReceptionRepository>();
            services.AddScoped<IInsuranceRepository, InsuranceRepository>();
            services.AddScoped<IPatientInforRepository, PatientInforRepository>();
            services.AddScoped<IKarteInfRepository, KarteInfRepository>();
            services.AddScoped<IRaiinKubunMstRepository, RaiinKubunMstRepository>();
            services.AddScoped<IRaiinCmtInfRepository, RaiinCmtInfRepository>();
            services.AddScoped<IUketukeSbtMstRepository, UketukeSbtMstRepository>();
            services.AddScoped<IKaRepository, KaRepository>();
            services.AddScoped<ICalculationInfRepository, CalculationInfRepository>();
            services.AddScoped<IGroupInfRepository, GroupInfRepository>();
            services.AddScoped<IKarteKbnMstRepository, KarteKbnMstRepository>();
            services.AddScoped<IPatientGroupMstRepository, PatientGroupMstRepository>();
            services.AddScoped<ISetMstRepository, SetMstRepository>();
            services.AddScoped<ISetGenerationMstRepository, SetGenerationMstRepository>();
            services.AddScoped<ISetKbnMstRepository, SetKbnMstRepository>();
            services.AddScoped<IPatientGroupMstRepository, PatientGroupMstRepository>();
            services.AddScoped<IInsuranceMstRepository, InsuranceMstRepository>();
            services.AddScoped<IRaiinFilterMstRepository, RaiinFilterMstRepository>();
            services.AddScoped<IPtCmtInfRepository, PtCmtInfRepository>();
            services.AddScoped<IUketukeSbtDayInfRepository, UketukeSbtDayInfRepository>();
            services.AddScoped<ICalculationInfRepository, CalculationInfRepository>();
            services.AddScoped<IImportantNoteRepository, ImportantNoteRepository>();
            services.AddScoped<IPatientInfoRepository, PatientInfoRepository>();
            services.AddScoped<ISummaryInfRepository, SummaryInfRepository>();
            services.AddScoped<IPtCmtInfRepository, PtCmtInfRepository>();
            services.AddScoped<IUserConfRepository, UserConfRepository>();
            services.AddScoped<IFlowSheetRepository, FlowSheetRepository>();
            services.AddScoped<ISystemConfRepository, SystemConfRepository>();
            services.AddScoped<IReceptionInsuranceRepository, ReceptionInsuranceRepository>();
            services.AddScoped<IColumnSettingRepository, ColumnSettingRepository>();
            services.AddScoped<IReceptionSameVisitRepository, ReceptionSameVisitRepository>();
            services.AddScoped<IFlowSheetRepository, FlowSheetRepository>();
            services.AddScoped<IReceptionInsuranceRepository, ReceptionInsuranceRepository>();
            services.AddScoped<IKarteFilterMstRepository, KarteFilterMstRepository>();
            services.AddScoped<IColumnSettingRepository, ColumnSettingRepository>();
            services.AddScoped<IReceptionSameVisitRepository, ReceptionSameVisitRepository>();
            services.AddScoped<IVisitingListSettingRepository, VisitingListSettingRepository>();
            services.AddScoped<IDrugDetailRepository, DrugDetailRepository>();
            services.AddScoped<IJsonSettingRepository, JsonSettingRepository>();
            services.AddScoped<ISystemGenerationConfRepository, SystemGenerationConfRepository>();
            services.AddScoped<IMstItemRepository, MstItemRepository>();
            services.AddScoped<IReceptionLockRepository, ReceptionLockRepository>();
            services.AddScoped<IDrugInforRepository, DrugInforRepository>();
            services.AddScoped<ISuperSetDetailRepository, SuperSetDetailRepository>();
            services.AddScoped<IUsageTreeSetRepository, UsageTreeSetRepository>();
            services.AddScoped<IMaxmoneyReposiory, MaxmoneyReposiory>();
            services.AddScoped<IMonshinInforRepository, MonshinInforRepository>();
            services.AddScoped<IRaiinListTagRepository, RaiinListTagRepository>();
            services.AddScoped<ISpecialNoteRepository, SpecialNoteRepository>();
            services.AddScoped<IHpInfRepository, HpInfRepository>();
            services.AddScoped<ITodayOdrRepository, TodayOdrRepository>();
            services.AddScoped<IHokenMstRepository, HokenMstRepository>();
            services.AddScoped<IPtTagRepository, PtTagRepository>();
            services.AddScoped<IAccountDueRepository, AccountDueRepository>();
            services.AddScoped<ITimeZoneRepository, TimeZoneRepository>();
            services.AddScoped<ISwapHokenRepository, SwapHokenRepository>();
            services.AddScoped<INextOrderRepository, NextOrderRepository>();
            services.AddScoped<IYohoSetMstRepository, YohoSetMstRepository>();
            services.AddScoped<IDocumentRepository, DocumentRepository>();
            services.AddScoped<IHistoryOrderRepository, HistoryOrderRepository>();
            services.AddScoped<ICommonGetListParam, CommonGetListParam>();
            services.AddScoped<IGroupNameMstRepository, GroupNameMstRepository>();
            services.AddScoped<IAccountingRepository, AccountingRepository>();
            services.AddScoped<ISanteiInfRepository, SanteiInfRepository>();
            services.AddScoped<IMedicalExaminationRepository, MedicalExaminationRepository>();
            services.AddScoped<ISystemConfigRepository, SystemConfRepostitory>();
            services.AddScoped<IRealtimeOrderErrorFinder, RealtimeOrderErrorFinder>();
