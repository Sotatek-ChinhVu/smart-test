...
{
    public class GetPtWeightResponse
    {
        public GetPtWeightResponse(int hpId, long ptId, long iraiCd, long seqNo, int iraiDate, long raiinNo, string kensaItemCd, string resultVal, string resultType, string abnormalKbn, int isDeleted, string cmtCd1, string cmtCd2, DateTime updateDate)
        {
            HpId = hpId;
            PtId = ptId;
            IraiCd = iraiCd;
